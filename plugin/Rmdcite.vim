...
"
" Original from Guillem Ballesteros
"

function! Rmdcite#init() " {{{1
  "
  ...
  setlocal omnifunc=Rmdcite#Complete
endfunction
...
function! Rmdcite#execute(exe) " {{{1
